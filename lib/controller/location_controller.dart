...
class LocationController extends GetxController implements GetxService {
  ...
  Future<AddressModel> getCurrentLocation(bool fromAddress, {GoogleMapController? mapController, LatLng? defaultLatLng, bool notify = true}) async {
    ...
    try {
      ...
      myPosition = Position(
        ...
        timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1, altitudeAccuracy: 0, headingAccuracy: 0,
      );
    }
    if(fromAddress) {
  ...
  void setUpdateAddress(AddressModel address){
    _position = Position(
      ...
      altitude: 1, heading: 1, speed: 1, speedAccuracy: 1, floor: 1, accuracy: 1, altitudeAccuracy: 0, headingAccuracy: 0,
    );
