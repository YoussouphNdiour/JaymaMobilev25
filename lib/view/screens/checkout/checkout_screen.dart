...
import 'package:sixam_mart/view/screens/checkout/widget/checkout_screen_shimmer_view.dart';
import 'package:sixam_mart/view/screens/checkout/widget/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:sixam_mart/view/screens/checkout/widget/bottom_section.dart';
import 'package:sixam_mart/view/screens/checkout/widget/top_section.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  final String  apipaymenturl= "https://api.silex.sn/app/api/one-step-payment";
                    ...
                    child: FooterView(child: SizedBox(
                      ...
                      child: ResponsiveHelper.isDesktop(context) ? Padding(
                        ...
                        Container(
                            ...
                            Text( orderController.paymentMethodIndex == 2 ? 'Orange Money'.tr : 'Wave'.tr, style: robotoMedium),
                            Image.asset(orderController.paymentMethodIndex == 2 ? Images.om : Images.wave, width: 60, height: 60),

                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            CustomTextField(
                              titleText: 'Numéro de téléphone',
                              hintText: 'Entrez votre numéro de téléphone',
                              controller: phoneController,
                              inputType: TextInputType.phone,
                              isPhone: true,  // Indique que c'est un champ de numéro de téléphone
                              countryDialCode: '+221',  // Remplacez par le code de pays initial souhaité
                            
                            ),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            CustomTextField(
                              titleText: 'Tapez le #144#391# entrer le code temporaire OTP',
                              hintText: 'Entrez votre code OTP',
    ...
    return Container(
      ...
      child: SafeArea(
        child: CustomButton(
          ...
          onPressed: orderController.acceptTerms ? () async {
            try {
      ...
      "amount":total.toString(),
       "numero_client":phoneController.text,
    }),
                Uri.parse(apipaymenturl));
                    print("phoneController.text ${phoneController.text}");

                print("response payment orange");
              ...
              if (status == "SUCCESS") {  
                  ...
                  if(isGuestLogIn && orderController.guestAddress == null && orderController.orderType != 'take_away') {
                    ...
                    if(isGuestLogIn && orderController.orderType == 'take_away') {
                      String number = orderController.countryDialCode! + guestContactPersonNumberController.text.replaceAll(' ', '');
                    ...
                    if(widget.storeId == null){
                      ...
                      PlaceOrderBody placeOrderBody = PlaceOrderBody(
                        ...
                        paymentMethod: orderController.paymentMethodIndex == 0 ? 'cash_on_delivery'
                            ...
                            : orderController.paymentMethodIndex == 2  ? 'digital_payment' : orderController.paymentMethodIndex == 6 ? 'digital_payment' : 'offline_payment',
                      ...
                      showCustomSnackBar(responseBody['detail']);
                  }
                } catch (e) {
                
                  return showCustomSnackBar("erreur");
                }
              } : null),
      ),
    );
